...
import {TimeTrackingAdapter, TimeTrackingExtraAdapter} from "../adapter/time-tracking.adapter";
...
export class TimeTrackingService {
    ...
    private getMethod = "get_worked_time_tracking";

    constructor(
        private appConfigService: AppConfigService,
        private http: HttpClient,
        private extraParamAdapter: TimeTrackingExtraAdapter,
        private adapter: TimeTrackingAdapter
    ) {
    }
