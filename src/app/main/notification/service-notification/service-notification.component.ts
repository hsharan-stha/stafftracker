...
export class ServiceNotificationComponent implements OnInit {
    ...
    pageTitle1 = "Edit Service Notification";
    pageTitle2 = "Notification Type";
    pageTitle3 = "Notification for the employers about being late for work.";
    pageTitle4 = "Select the time through which the employee should be notified that he is late for work.";
    empPositionList = [{'id':1,'name':'Senior Developer'},{'id':2,'name':'Junior Developer'},{'id':2,'name':'Intern'}];
    empGroupList = [{'id':1,'name':'Developer'},{'id':2,'name':'Quality Control'},{'id':2,'name':'Manager'}];
    constructor(
      ...
      this.route.params
      .pipe(takeUntil(componentDestroyed(this))).subscribe( params => this.position_id = parseInt(params['id']));
    }
  
    ngOnInit() {
      this.createForm();
      this.initForm();
      //titles to display for edit page
      if(this.position_id){
        this.pageTitle1 = "Edit position";
        this.pageTitle2 = "Edit position";
        this.pageTitle3 = "On this page you can edit position.";
        this.positionForm.patchValue({
          name : "Previous position name",

        });
      }
    }
    initForm(){
        this.scheduleSetupForm = this.fb.group({
            'checkboxMO' : [true],
            'checkboxTU' : [true],
            'checkboxWE' : [true],
            'checkboxTH' : [true],
    ...
    storePosition() {
      if (this.positionForm.valid) {
        console.log(this.positionForm.value.name);
